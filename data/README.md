...
| `skill_input_T6_A/_B/_C.md` | T6输入：按桶分文件的候选池CSV | T6 | 喂给LLM做语义排序 | 单桶重跑只覆盖对应桶文件，互不污染 |
| `skill_output_T6_A/_B/_C.md` | T6输出：LLM三档全量分析 | 人工/CI喂LLM | 研究材料 | 推荐/中立/不推荐三档全量+行业分组分析 |
